...
interface AddDragonfiFundModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (transaction: { date: string; amountPhp: number }) => void;
}

const AddDragonfiFundModal: React.FC<AddDragonfiFundModalProps> = ({ isOpen, onClose, onSave }) => {
...
export default AddDragonfiFundModal;
