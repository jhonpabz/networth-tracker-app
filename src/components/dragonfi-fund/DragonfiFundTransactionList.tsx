...
import { DragonfiFundTransaction } from '../../types/DragonfiFund';
import { formatCurrency } from '../../utils/formatCurrency';
import DeleteDepositModal from '../gotrade/DeleteDepositModal';

interface DragonfiFundTransactionListProps {
...
const DragonfiFundTransactionList: React.FC<DragonfiFundTransactionListProps> = ({
  transactions,
  onDelete,
}) => {
  const [pendingDelete, setPendingDelete] = useState<DragonfiFundTransaction | null>(null);
...
export default DragonfiFundTransactionList;
